...
import cisco from "../Assets/certificates/cert2.jpg";
        ...
        >
            <div className="resume-parent">
                <div className="resume-text">
                    ...
                    <div className="resume-question">My Formal Bio Details</div>
                                ...
                                >
                                    ...
                                    <div className="resume-right-sec4">
                                        <div className="project-main">
                                            ...
                                            <div className="project-description">
                                                <p>
                                                    Pizza's selling website on
                                                    which user can create their
                                                    account and order the
                                                    pizza's for temproray
                                                    purpuse Stripe payment
                                                    method i used to make
                                                    payment.
                                                </p>
                                            </div>
                                        </div>
